...
//
//    private final Logger logger = LoggerFactory.getLogger(MoodDetailService.class);
//
...
//
//        if (moodDetail == null || moodDetail.getEntryDateTime() == null || moodDetail.getDetailedEntry() == null) {
//            throw new IllegalArgumentException("MoodDetail object is invalid");
//        }
//
